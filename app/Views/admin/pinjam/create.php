...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('pinjam/store'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    echo form_dropdown('id_anggota', $anggota,'id_anggota', ['class' => 'form-control']);
                                    ?>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    echo form_dropdown('id_buku', $buku, 'id_buku', ['class' => 'form-control']);
                                    ?>
                                </div>
                                <div class="form-group">
