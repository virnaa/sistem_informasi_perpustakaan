                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="<?php echo base_url('kembali/delete/' . $row['id_kembali']); ?>" title="hapus pengembalian" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus pengembalian ini?');">
